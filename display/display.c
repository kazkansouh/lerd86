...
static const int pin_station = 5;
static const int pin_ap = 4;

static os_timer_t error_timer_t;
static os_timer_t spi_timer_t;
...
void ICACHE_FLASH_ATTR user_init() {
  ...
  SpiAttr attr = {SpiMode_Master, SpiSubMode_0, SpiSpeed_0_5MHz, SpiBitOrder_MSBFirst};
